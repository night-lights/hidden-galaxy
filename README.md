...
> _Every codebase is a galaxy. Dependencies are gravitational relationships. Packages are celestial bodies._
...
Dependencies are the invisible fabric of modern software. We declare them, we update them, we occasionally break them—but we rarely _see_ them. They're abstract relationships we feel in stack traces and build failures, but never experience as tangible, spatial things.

**Hidden Galaxy makes dependency graphs visible, beautiful, and explorable.**

This isn't a debugging tool or an optimization utility. It's an art piece that asks: _What if we could walk through our code like astronomers navigating the cosmos?_ What patterns would emerge? What beauty would we find in the structure itself?
...
This project is part of the **Night Lights** series—a collection of art explorations that approach code through beauty rather than utility. The goal isn't to ship faster or debug better. The goal is to _see code differently_.
...
Other projects in the series: _Coming soon_

---

**Built with curiosity. Designed for beauty. Made for exploration.**

_Questions, ideas, or just want to share what you built? Open an issue or reach out._
